...
export async function handler(event) {
  ...
  try {
    ...
    // Initialize OpenAI SDK with OpenRouter settings
    ...
    // Call a simple completion using the free model
    const response = await openai.chat.completions.create({
      model: "deepseek/deepseek-r1:free",
      messages: [
        {
          role: 'system',
          content: 'You are a connection test assistant. Respond with exactly: Connection successful!'
        },
